# Flora & Firewall UE5 Style Guide() {

*A mostly reasonable approach to Unreal Engine 5*

Forked from [Allar's Guide](https://github.com/Allar/ue5-style-guide?tab=readme-ov-file)
...
I'm not a lawyer, but please don't introduce illegal actions and behavior to a project, including but not limited to:
